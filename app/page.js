...
export default function Home() {
  return (
    <>
      <div className="min-h-screen flex items-center justify-between px-20 bg-gradient-to-br from-white via-slate-50 to-slate-100">
        
        
        <section className="flex flex-col justify-center text-left ml-32 space-y-6">
